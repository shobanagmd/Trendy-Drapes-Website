  ...
  <div className="min-h-screen flex flex-col bg-background">
    ...
    <div className="container mx-auto px-4 py-12 flex-1 max-w-3xl">
      ...
      <div className="font-body text-sm text-muted-foreground space-y-4 leading-relaxed">
        ...
        <p>Founded in 2026, we are passionate about preserving India's rich textile heritage while making it accessible to the modern woman. Every piece in our collection tells a story — of the weaver's skill, the fabric's journey, and the tradition it carries.</p>
