...
/*  MAIN COMPONENT                                                */
/* ═══════════════════════════════════════════════════════════════ */
export default function SellerOnboarding({ isEmbedded = false }) {
  ...
  return (
    <>
      <style>{CSS}</style>
      <div className="ob-root" style={isEmbedded ? { minHeight: "auto" } : {}}>
        ...
        <div className="ob-layout">
          ...
          {/* ── Main content ── */}
          <main className="ob-main" style={isEmbedded ? { maxWidth: "none", padding: "1rem 0" } : {}}>
